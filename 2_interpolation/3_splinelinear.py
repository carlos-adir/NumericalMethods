# -*- coding: utf-8 -*-
"""
           @file: 3_splinelinear.py
           @date: 20th December 2020
         @author: Carlos Adir (carlos.adir.leite@gmail.com)
          @title: Linear Spline Algorithm
"""


from methods import SplineLinear
import numpy as np
...
if __name__ == "__main__":
    ...
    YL = SplineLinear(x, y, X)
    YL_plot = SplineLinear(x, y, x_plot)  # For plotting graph
